...
static const struct mxs_pm_socdata imx23_pm_data __initconst = {
	.clkctrl_compat = "fsl,imx23-clkctrl",
	.power_compat = "fsl,imx23-power",
	.dram_compat = "fsl,imx23-dram",
	.pinctrl_compat = "fsl,imx23-pinctrl",
	.emi_compat = "fsl,imx23-emi",
	.icoll_compat = "fsl,imx23-icoll",
	.rtc_compat = "fsl,imx23-rtc",
	.suspend_asm = &mx23_cpu_standby,
	.suspend_asm_sz = &mx23_cpu_standby_sz,
};
...
static int __init mxs_suspend_init(void)
{
	...
	if (of_device_is_compatible(np, imx23_pm_data.clkctrl_compat))
		soc_data = &imx23_pm_data;
	else if (of_device_is_compatible(np, imx28_pm_data.clkctrl_compat))
